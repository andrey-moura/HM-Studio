...
void decompress(std::ifstream& rom, size_t offset) {
    ...
    *((uint32_t*)stack.data()) = byte;
    ...
    std::cout << "Magic Number: " << std::hex << (int)magic_number << std::endl;
    std::cout << "Target Size: " << std::hex << (int)target_size << std::endl;
    ...
    auto display_stack = [&]() {
        ...
        for (int y = 0; y < 8; ++y) { 
            for(int x = 0; x < 16; ++x) {
                ...
                std::cout << std::hex << std::setw(2) << std::setfill('0') << (int)stack[i] << " ";
                i++;
            }
            std::cout << std::endl;
            if(i >= stack.size()) {
    ...
    case 3:
        {
            ...
            auto find_negative = [&]() -> int16_t {
                if(some_callback != 0x080D8DA7) {
                    throw std::runtime_error("Not implemented yet.");
                }
                int16_t var4 = 0x20;

                //std::cout << "080D8FB4 buffer: " << std::hex << (int)bit_reader.buffer() << std::endl;
                //std::cout << "080D8FB4 available_bits: " << std::hex << (int)bit_reader.available_bits() << std::endl;
                //available_bits--;
                // LAB_080D8FB0
                while(1) {
                    // LAB_080D8DB4
            ...
            while(bytes_written < target_size) {
                ...
                if(!carry) {
                    ...
                    // std::cout << "LAB_080D8FDC R2: " << std::hex << (int)bit_reader.buffer() << std::endl;
                    // std::cout << "LAB_080D8FDC R3: " << std::hex << (int)bit_reader.available_bits() << std::endl;
                    // std::cout << "LAB_080D8FDC R5: " << std::hex << (int)var5 << std::endl;
                    // std::cout << std::endl;
                    // std::cout << std::endl;
                    // LAB_080D8FDE
                    ...
                    // std::cout << "LAB_080D8FDC R2: " << std::hex << (int)bit_reader.buffer() << std::endl;
                    // std::cout << "LAB_080D8FDC R3: " << std::hex << (int)bit_reader.available_bits() << std::endl;
                    // std::cout << "LAB_080D8FDC R4: " << std::hex << (int)var4 << std::endl;

                    // LAB_080D8FDE
                    var4 <<= 8;
                    //std::cout << "LAB_080D8FDC: " << std::hex << (int)var4 << std::endl;

                    // LAB_080D8FE0
                    var4 |= var5;
                    //std::cout << "LAB_080D8FE0: " << std::hex << (int)var4 << std::endl;
                    ...
                    // std::cout << std::endl;
                    // std::cout << std::endl;
                    // std::cout << "bytes written: " << std::hex << bytes_written * 2<< std::endl;
                    // std::cout << std::endl;
                    // std::cout << std::endl;
                    // std::cout << std::endl;
                } else {
                    // std::cout << "LAB_080D8DD2 R2: " << std::hex << (int)bit_reader.buffer() << std::endl;
                    // std::cout << "LAB_080D8DD2 R3: " << std::hex << (int)bit_reader.available_bits() << std::endl;
                    if(bytes_written * 2 >= 0x456) {
                        std::string();
                    }
                    // 080D8FE8
                    uint32_t var4 = bit_reader.read_bits(2);
                    //std::cout << "080D8FE8 R4: " << std::hex << (int)var4 << std::endl;
                    ...
                    if(var4 != 3) {
                        // 080D8FF2
                        var5 = var4 << 2;
                        //std::cout << "080D8FF2 R5: " << std::hex << (int)var5 << std::endl;
                        // 080D8FF4/080D8FF6
                        var4 = stack[var5 + 6];
                        //std::cout << "080D8FF4 R4: " << std::hex << (int)var4 << std::endl;
